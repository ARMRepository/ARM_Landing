...
<head>
    ...
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <title>Aarnav - Cryptocurrencies</title>
...
<body class="otherpage">
    ...
    <div class="main-wrapper">
        ...
        <footer class="footer bg-img p-80">
            <div class="container">
                    ...
                    <div class="col-sm-12">
                        <div class="single">
                            ...
                            <div class="input-group">
                                <input type="email" class="form-control" placeholder="Leave Your Email">
                ...
                <div class="col-sm-12"><p class="text-center white-txt">Operating  <img src="img/usa_icon.png" style="width:20px;"> in US</p></div>
                <!-- Foot Bottom Ends -->
            </div>
        </footer>
        <!-- Footer Ends -->
    ...
    $("h5.static-tit").click(function(){
        ...
        $(this).parent().find("p.static-txt").toggle('slow');
